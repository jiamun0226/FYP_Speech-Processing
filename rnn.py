...
s_model = tf.keras.models.load_model("/home/mustar/catkin_ws/src/fyp/student_model")
with open('/home/mustar/catkin_ws/src/fyp/student_model/tokenizer.pkl', 'rb') as input:
    tokenizer = pickle.load(input)

f = open("/home/mustar/catkin_ws/src/fyp/respond.txt", "r")
read = f.read()
f.close()
sms = [read]
...
f = open("/home/mustar/catkin_ws/src/fyp/identity.txt", "w")
f.write(identity)
f.close()
