...
def user_input():
  ...
  root.geometry("400x100+750+300")

  name_var=tk.StringVar()
  id_var=tk.StringVar()

  def submit():
      text = "Thank you for your cooperation. Your information have been recorded."
...
def createpdf():
  ...
  f = open("/home/mustar/catkin_ws/src/fyp/identity.txt", "r") # Get Identity
  identity = f.read()
  f.close()
  ...
  pdf.image("/home/mustar/catkin_ws/src/fyp/Smoker.jpg", x = 70, y = 35, w = 70, h = 0, type = 'JPG', link = '')
  ...
  pdf.text(x=30,y=130,txt = 'Location Detected: ')
  ...
  pdf.output('/home/mustar/catkin_ws/src/fyp/Smoker_Detection_Report.pdf', 'F')
  return name
